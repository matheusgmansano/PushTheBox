...
export default {
  // Aplica o mixin que contém a lógica do jogo para o mapa4,
  // define a rota da próxima fase e o tempo limite (40s)
  mixins: [createScript(mapa4, '/fase5', 40)],
  data() {
    return {
      mostrarMenu: false, // Controla a visibilidade do menu suspenso
  ...
  mounted() {
    ...
    // Toca a música da fase 4 (mesma música da fase 3 aqui)
...
<template>
  ...
  <div class="tela">
    <!-- Título da fase -->
    <h1 style="margin-bottom: -10px;">Fase 4</h1>
