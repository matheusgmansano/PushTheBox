<script>
// Importa o mapa da fase 7
import { mapa7 } from '@/mapas/mapa7.js';
...
export default {
  // Usa o mixin para criar a lógica da fase 7, próxima fase é a 8, tempo limite 40 segundos
  mixins: [createScript(mapa7, '/fase8', 40)],
  data() {
    return {
      mostrarMenu: false,
      somClique: null,
  ...
  mounted() {
    ...
    // Toca a música da fase 7 usando o caminho absoluto
...
<template>
  ...
  <div class="tela">
    <!-- Título da fase -->
    <h1 style="margin-bottom: -10px;">Fase 7</h1>
