<script>
// Importa o mapa da fase 9 que será usado nesta fase
...
export default {
  // Usa o mixin para criar a lógica da fase 9, próxima fase é a 10, tempo limite 40 segundos
  ...
  mounted() {
    ...
    // Toca a música da fase 8 (provavelmente queria a música da fase 9)
